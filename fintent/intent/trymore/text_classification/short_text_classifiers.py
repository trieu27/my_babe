...
def load_synonym_dict(file_path):
    ...
    """
    sym_dict = dict()
    with open(file_path,encoding="utf8") as fr:#'r'
        lines = fr.readlines()
...
word2vec_model = Word2Vec.load('C:/Users/USER/Desktop/my_project/fintent/intent/trymore/models/pretrained_word2vec.bin')
    # Please give the correct paths
tokenizer = CrfTokenizer(config_root_path='C:/Users/USER/Desktop/my_project/fintent/intent/trymore/tokenization/',
                             model_path='C:/Users/USER/Desktop/my_project/fintent/intent/trymore/models/pretrained_tokenizer.crfsuite')
sym_dict = load_synonym_dict('C:/Users/USER/Desktop/my_project/fintent/intent/trymore/data/sentiment/synonym.txt')
...
keras_text_classifier = BiDirectionalLSTMClassifier(tokenizer=tokenizer, word2vec=word2vec_model.wv,
                                                        model_path='C:/Users/USER/Desktop/my_project/fintent/intent/trymore/models/sentiment_model.h5',
                                                        max_length=10, n_epochs=10,
                                                        sym_dict=sym_dict)
label_dict = {0: 'giới thiệu', 1: 'sự kiện - lễ hội', 2: 'giải trí', 3: 'bắt đầu', 4: 'tour', 
              5:'thông tin du lịch', 6: 'khẩn cấp', 7:'livechat', 8:'điểm du lịch', 9: 'thiên nhiên',
              10: 'di tích', 11: 'bãi tắm'}
